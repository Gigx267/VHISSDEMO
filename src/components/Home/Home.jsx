  ...
  return (
    <React.Fragment>
      <div id="Home" className="tablet:grid-col padding-x-2">
        <p>Before using VIHSS to check for symptoms , please read carefully and accept our Terms and Services:</p>
        <ul>
          <li>This checkup is not a diagnosis. You will still have to visit Veritas University Clinic for futher instructions </li>
          <li>This checkup is for informational purposes and is not a qualified medical opinion.</li>
          <li>Information that you provide is anonymous and not shared with anyone. We also do not store any information </li>
        </ul>
        <form class="usa-form TermsCheckbox">
          <div class="usa-checkbox">
            ...
            <label class="usa-checkbox__label" for="truth">
              I agree to the VIHSS  terms and conditions
            </label>
          </div>
        </form>
      </div>
