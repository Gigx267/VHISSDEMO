    ...
    return filtered_list.length !== 0 ? (
      <div className="grid-row width-full DiseaseComponent">
        <div className="col-12 tablet:grid-col-12 patientInfo">
          <h3>Student  gender: {this.props.gender}</h3>
        ...
        <div>Visit A Medical Staff At  Block D Ground Floor For Futher Explainations and Treatment </div>
      </div>
    ) : (
      <React.Fragment>
        <div className="grid-row width-full DiseaseComponent">
          <div className="col-12 tablet:grid-col-12 patientInfo">
            <h3>Student  gender: Male</h3>
            <h3>Student age: 20</h3>
          </div>
          <p> Cannot determine possible diseases due to lack of symptoms. Please retry the analysis with actual symptoms or vistt Veritas Clinic right away located at Block D ground floor </p>
        </div>
      </React.Fragment>
    );
  };
